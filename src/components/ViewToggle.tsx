...
export default function ViewToggle({ className = '' }: Props) {
  ...
  return (
    <div
      aria-label="작품 보기 방식"
      className={twMerge(
        'relative inline-grid grid-cols-2 overflow-hidden rounded-xl border border-white/8 bg-zinc-950/80 p-[2px] text-sm text-zinc-400 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]',
        className,
      )}
      role="radiogroup"
    >
      <div
        aria-hidden
        className="pointer-events-none absolute inset-y-[2px] left-[2px] w-[calc(50%-2px)] rounded-[0.65rem] border border-white/10 bg-zinc-100 shadow-[0_5px_14px_rgba(0,0,0,0.22)] transition ease-out"
