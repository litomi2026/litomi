...
process.env.NEXT_PUBLIC_PROXY_ORIGIN ??= 'https://example.com'
process.env.NEXT_PUBLIC_PROXY_NEW_ORIGIN ??= process.env.NEXT_PUBLIC_PROXY_ORIGIN
process.env.NEXT_PUBLIC_PROXY_SEARCH_ORIGIN ??= process.env.NEXT_PUBLIC_PROXY_ORIGIN
