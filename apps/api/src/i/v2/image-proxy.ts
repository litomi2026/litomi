...
import { createAllowedRequestInitiatorMiddleware } from '@/middleware/allowed-request-initiator'
...
function matchesHostSuffix(hostname: string, hostSuffixes: readonly string[]): boolean {
