...
const envMock = {
  ...
  NEXT_PUBLIC_PROXY_ORIGIN: process.env.NEXT_PUBLIC_PROXY_ORIGIN ?? 'http://localhost:3001',
  NEXT_PUBLIC_PROXY_NEW_ORIGIN:
    process.env.NEXT_PUBLIC_PROXY_NEW_ORIGIN ?? process.env.NEXT_PUBLIC_PROXY_ORIGIN ?? 'http://localhost:3001',
