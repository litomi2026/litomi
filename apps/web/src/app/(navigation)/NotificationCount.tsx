...
export default function NotificationCount() {
  ...
  return (
    <span
      className={twMerge(
        'absolute top-1/2 -translate-y-5 right-1/2 translate-x-5 flex h-4 px-1 items-center justify-center rounded-full bg-brand text-[10px] font-bold text-background',
