          ...
          <div className="mt-3 flex flex-col gap-2 sm:flex-row">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="h-10 w-full rounded-lg border border-zinc-800 bg-zinc-950/45 pl-9 pr-3 outline-none transition placeholder:text-zinc-500 focus:border-zinc-600 focus:ring-2 focus:ring-brand/15 disabled:opacity-50"
                disabled={isLoading || isDeleting}
