...
import { renderBoldMarkdown } from '@/app/[locale]/(navigation)/chat/util/renderBoldMarkdown'
import { getAssistantPlaceholderText, getChatIntroText } from '@/app/[locale]/(navigation)/chat/util/uiText'
