...
export default function ErrorPage({ error, reset }: Props) {
  ...
  return (
    <main className="flex flex-col grow justify-center items-center gap-6 text-center">
      ...
      <button
        className="bg-zinc-700 text-sm font-semibold rounded-full min-w-50 hover:bg-zinc-600 active:bg-zinc-700 px-4 py-2 transition disabled:bg-zinc-600 disabled:text-zinc-400"
        disabled={cooldown > 0}
        onClick={reset}
      >
