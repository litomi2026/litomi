...
export const nextBuildEnv = createEnv({
  server: {
    ...
    NEXT_PUBLIC_PROXY_ORIGIN: z.url().default(env.NEXT_PUBLIC_PROXY_ORIGIN),
    NEXT_PUBLIC_PROXY_NEW_ORIGIN: z.url().default(env.NEXT_PUBLIC_PROXY_NEW_ORIGIN),
    NEXT_PUBLIC_PROXY_RANDOM_ORIGIN: z.url().default(env.NEXT_PUBLIC_PROXY_RANDOM_ORIGIN),
