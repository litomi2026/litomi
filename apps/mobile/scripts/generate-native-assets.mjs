...
const sourcePath = path.resolve(mobileDir, '../web/public/web-app-manifest-512x512.png')
...
const iosIconTarget = ['ios/App/App/Assets.xcassets/AppIcon.appiconset/AppIcon-512@2x.png', 1024]
